...
def wallets(request):
    ...
    context = {
        'wallets': wallets,  # Original wallets for backward compatibility
        'wallets_with_usd': wallets_with_usd,  # Wallets with USD values
        'total_balance': total_balance_usd,  # Total portfolio value in USD
    }
    
    return render(request, 'staking/wallets.html', context)